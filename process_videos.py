...
def process_single_video(video_path):
    ...
    needs_looping = duration is not None and duration < 10  # Loop videos shorter than 10 seconds (like Reena Veloria)
    ...
    if has_audio:
        if needs_looping:
            # Use aloop filter for audio (simpler and more efficient - from Reena Veloria)
