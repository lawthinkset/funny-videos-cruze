...
def upload_to_youtube(video_path, title, description, tags=None, category_id='22'):
    ...
    if tags is None:
        tags = ["tomandjerry", "classiccartoons", "funny", "nostalgia", "animation", "childhood", "catandmouse", "shorts", "reels"]
...
def main():
    ...
    title = "Tom and Jerry Classic"
    description = "The world's most famous cat and mouse duo are back at it! #shorts #tomandjerry #classiccartoons"
    tags = ["tomandjerry", "classiccartoons"]
